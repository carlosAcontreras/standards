...
var map = {
	...
	"./detail-standards/detail-standards.module": [
		"./src/app/component/detail-standards/detail-standards.module.ts",
		"common",
		"detail-standards.module"
	],
	"./list-standards/list-standards.module": [
		"./src/app/component/list-standards/list-standards.module.ts",
		"common",
		"list-standards.module"
	],
	"./login/login.module": [
    ...
    AppRoutingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot(rourtes)
            ],
