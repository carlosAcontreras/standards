...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.getToken = function (rform) {
        var url = 'http://138.197.119.196/lcperformance/inicio_sesion_expa/?correo=' + rform.email + '&password=' + rform.password + '';
        return this._http.get(url).map(function (res) { return res.json(); });
    };
    AuthService.prototype.getCurrentPerson = function (token) {
        var url = 'https://gis-api.aiesec.org/v2/current_person.json?access_token=' + token + '';
        return this._http.get(url).map(function (res) { return res.json(); });
    };
    AuthService.prototype.getStandards = function (token) {
        var url = 'http://138.197.119.196/lcperformance/get_opportunities/?token=' + token + '';
        return this._http.get(url).map(function (res) { return res.json(); });
    };
    AuthService.prototype.putStandards = function (obj, value) {
        var url = 'https://gis-api.aiesec.org/v2/applications/' + obj.id_oportunity + '/update_standards';
        var token = localStorage.getItem('token');
        var data = 'access_token=' + token + '&application%5Bstandards%5D%5Bid%5D=' + obj.id + '&application%5Bstandards%5D%5Boption%5D=' + value + '';
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        return this._http.patch(url, data, { headers: headers });
    };
    AuthService.prototype.sessionValidate = function () {
...
/***/ "./src/app/services/standares.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StandaresService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var StandaresService = /** @class */ (function () {
    function StandaresService() {
    }
    StandaresService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [])
    ], StandaresService);
    return StandaresService;
}());
