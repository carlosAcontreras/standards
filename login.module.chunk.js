...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_standares_service__ = __webpack_require__("./src/app/services/standares.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, _StandaresService, _AuthService, router) {
        this.fb = fb;
        this._StandaresService = _StandaresService;
        this._AuthService = _AuthService;
        this.router = router;
        this.rForm = fb.group({
            'email': [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* Validators */].email])],
    ...
    LoginComponent.prototype.startLogin = function (rForm) {
        var _this = this;
        this._AuthService.getToken(rForm).subscribe(function (response) {
            _this.authLogin(response, rForm);
        }, function (error) {
            console.log('problemas de conexion');
            return;
        });
    };
    LoginComponent.prototype.authLogin = function (validate, rForm) {
        if (validate.result) {
    ...
    LoginComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_5__services_standares_service__["a" /* StandaresService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_5__services_standares_service__["a" /* StandaresService */], __WEBPACK_IMPORTED_MODULE_2__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* Router */]])
    ], LoginComponent);
